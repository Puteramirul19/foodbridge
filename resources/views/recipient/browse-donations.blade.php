                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php 
                                                    ...
                                                    $daysLeft = $now->diffInDays($bestBeforeDate, false);
                                                    $isExpired = $bestBeforeDate->isPast();
                                                ...
                                                @else
                                                    <span class="text-success">
                                                        {{ $bestBeforeDate->format('d M Y') }}
                                                        <small class="d-block">({{ $daysLeft }} days left)</small>
                                                    </span>
                                                @endif
                                            </td>
                                            <td>
                                                @if($isExpired)
                                                    <button type="button" class="btn btn-sm btn-secondary" disabled>
                                                        <i class="fas fa-times me-2"></i>Expired
                                                    </button>
                                                @else
